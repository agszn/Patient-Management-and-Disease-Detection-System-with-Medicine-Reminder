...
def dashboard(request):
    ...
    non_admin_count = User.objects.filter(is_staff=False).count()
    ...
    return render(request, "dashboard/dashboard_smartmedical.html", context=context)
...
def create_notification(request):
    if request.method == 'POST':
        ...
        return render(request, 'notification/create_notification.html', {'users': users})
...
@login_required
def chat(request):
    return render(request, 'chat/chatdemo.html')
